...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Society',
            fields=[
                ('building_id', models.AutoField(default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Building.apartment')),
            ],
        ),
        migrations.CreateModel(
            name='Reservations',
